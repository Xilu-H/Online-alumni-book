...
cityDropdown.options[1].selected=true;
            ...
            function check()
            {
                if(document.formAdd.chinaProvince.value=="选择")
                {
                    alert("请选择所在省市");
                    return false;
                }
                if(document.formAdd.chinaCity.value=="选择")
                {
                    alert("请选择所在城市");
                    return false;
                }
	...
	<body leftmargin="8" topmargin="8" background='<%=path %>/img/allbg.gif'>
			<form action="<%=path %>/yuanxiaoAdd.action" name="formAdd" method="post">
				     <table width="80%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA">
						...
						<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
						    ...
						    <td width="75%" bgcolor="#FFFFFF" align="left">
						        <select name="chinaCity" id="chinaCity" style="width: 200px;">
