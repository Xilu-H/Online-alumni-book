...
<TABLE cellSpacing=0 cellPadding=0 width=210 align=center border=0>
  <TR>
    ...
    <TD vAlign=top width=180 bgColor=#ffffff>
      <TABLE cellSpacing=0 cellPadding=3 width=165 align=center border=0>
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=2 width=155 align=center border=0>
              <TR><TD class=menuSmall><A class=style2 href="<%=path %>/admin/user/userMana.action" target=dmMain>－ 用户管理</A></TD></TR>
			</TABLE>
		  </TD>
		</TR>
        <TR><TD background=<%=path %>/img/new_027.jpg height=1></TD></TR><TR>  
        ...
        <!--  -->
        <TR><TD class=mainMenu>学校信息管理</TD></TR>
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=2 width=155 align=center border=0>
              <TR><TD class=menuSmall><A class=style2 href="<%=path %>/admin/yuanxiao/yuanxiaoAdd.jsp" target=dmMain>－ 添加学校信息</A></TD></TR>
              <TR><TD class=menuSmall><A class=style2 href="<%=path %>/admin/yuanxiao/yuanxiaoSea.jsp" target=dmMain>－ 查询学校信息</A></TD></TR>
			</TABLE>
		  </TD>
		</TR>
        <TR><TD background=<%=path %>/img/new_027.jpg height=1></TD></TR><TR>  
        <!--  -->  
            <TR><TD class=mainMenu>班级信息管理</TD></TR>
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=2 width=155 align=center border=0>
              <TR><TD class=menuSmall><A class=style2 href="<%=path %>/banjiMana.action" target=dmMain>－ 班级信息管理</A></TD></TR>
			</TABLE>
		  </TD>
		</TR>
        <TR><TD background=<%=path %>/img/new_027.jpg height=1></TD></TR><TR>  
   ...
   <!--  -->
        ...
        <!--  -->
        <TR><TD class=mainMenu>照片信息管理</TD></TR>
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=2 width=155 align=center border=0>
              <TR><TD class=menuSmall><A class=style2 href="<%=path %>/zhaopianMana.action" target=dmMain>－ 照片信息管理</A></TD></TR>
			</TABLE>
		  </TD>
		</TR>
        <TR><TD background=<%=path %>/img/new_027.jpg height=1></TD></TR><TR>  
